...
# Error in VisTextNetD3(sotu_text_network, prune_cut = 0.5, height = 1000,  : 
#  unused argument (prune_cut = 0.5) -- Taking this argument out save the widget just fine.
