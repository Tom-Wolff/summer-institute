...
As a brief aside, the `rtweet` package also interfaces nicely with ggplot and other visualization libraries to produce nice plots of the results above. For instance, let's make a plot of the frequency of tweets about Korea over the past few days:
